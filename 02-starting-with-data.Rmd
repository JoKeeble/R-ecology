...
# Presentation of the Cytokine Data
...
The dataset is stored as a `csv` file: each row holds information for a single patient, and the columns
represent:
...
download.file("http://files.figshare.com/2441249/Cytokines.csv",
